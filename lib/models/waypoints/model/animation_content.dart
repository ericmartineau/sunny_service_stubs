...
abstract class IAnimationContent
  implements IContent {

  static late _AnimationContentConstructor of;
  static late _AnimationContentFromJson fromJson;
  ...
  @override
  IAnimationContent clone();

  @override
  Set<String> get mfields => AnimationContentFields.values;

}

class AnimationContentFields {
  ...
  static const animationId = "animationId";
  static const loop = "loop";
  static const Set<String> values = {
    dismissible, repeatsFor, showEvery, delivery, durationUnit, durationAmount, delayUnit, delayAmount, animationId, loop
  };
}

class AnimationContentPaths {
  ...
  static const JsonPath<String> animationId = JsonPath.internal(["animationId"], "/animationId");
...
const AnimationContentRef = MSchemaRef("sunny", "content", "animationContent", "0.0.1", "ephemeral");

typedef _AnimationContentConstructor = IAnimationContent Function({   required bool? dismissible, 
  int? repeatsFor, 
  int? showEvery, 
...
typedef _AnimationContentFromJson = IAnimationContent Function(dynamic any);