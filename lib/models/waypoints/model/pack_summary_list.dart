...
abstract class IPackSummaryList
  implements MModel, MModelList<IPackSummary> {

  static late _PackSummaryListConstructor of;
  static late _PackSummaryListFromJson fromJson;
...
typedef _PackSummaryListConstructor = IPackSummaryList Function({   int? count, 
  List<IPackSummary>? data
 });
typedef _PackSummaryListFromJson = IPackSummaryList Function(dynamic any);