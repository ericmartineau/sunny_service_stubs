...
class FlowFrameFields {
  ...
  static const Set<String> values = {
    thread, task, started, nodeId, taskOperationRef, isAssisted, skippable, completed, due, status, isActive, state, result, logs
  };
}
...
typedef _FlowFrameConstructor = IFlowFrame Function({   required IFlowThreadForFlowFrame? thread, 
  IAssistedTask? task, 
