...
abstract class IContent
  ...
  static late _ContentConstructor of;
  static late _ContentFromJson fromJson;
...
typedef _ContentConstructor = IContent Function({   required bool? dismissible, 
  int? repeatsFor, 
  int? showEvery, 
...
typedef _ContentFromJson = IContent Function(dynamic any);