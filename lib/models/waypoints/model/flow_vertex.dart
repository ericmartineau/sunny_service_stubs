...
abstract class IFlowVertex
  implements MModel {

  static late _FlowVertexConstructor of;
  static late _FlowVertexFromJson fromJson;
...
typedef _FlowVertexConstructor = IFlowVertex Function({   required String? vertexId, 
  required List<IExpression>? conditions
 });
typedef _FlowVertexFromJson = IFlowVertex Function(dynamic any);