...
///
abstract class IEmployeeApi extends Repository<IEmployee> /* sunny:fact:schema:employee:0.0.1@mverse*/{

  @override
  MSchemaRef get mtype => EmployeeRef;

  Future<IEmployee> create(IEmployee employee,);
    
  Future<DeleteResponse> delete(String id,);
    
  Future<IEmployeeList> list({ double? limit,  double? offset });
    
  Future<IEmployee> load(String id,);
    
  Future<ChangeResult> update(String id, IEmployee employee,);
