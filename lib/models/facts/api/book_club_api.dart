...
import '../model/book_club_list.dart';
...
///
abstract class IBookClubApi extends Repository<IBookClub> /* sunny:fact:schema:bookClub:0.0.1@mverse*/{

  @override
  MSchemaRef get mtype => BookClubRef;

  Future<IBookClub> create(IBookClub bookClub,);
    
  Future<DeleteResponse> delete(String id,);
    
  Future<IBookClubList> list({ double? limit,  double? offset });
    
  Future<IBookClub> load(String id,);
    
  Future<ChangeResult> update(String id, IBookClub bookClub,);
