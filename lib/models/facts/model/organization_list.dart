...
abstract class IOrganizationList
  implements MModel, MModelList<IOrganization> {

  static late _OrganizationListConstructor of;
  static late _OrganizationListFromJson fromJson;
...
typedef _OrganizationListConstructor = IOrganizationList Function({   int? count, 
  List<IOrganization>? data
 });
typedef _OrganizationListFromJson = IOrganizationList Function(dynamic any);