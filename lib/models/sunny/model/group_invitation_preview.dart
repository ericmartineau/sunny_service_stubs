...
abstract class IGroupInvitationPreview implements MModel {
  static late _GroupInvitationPreviewConstructor of;
  static late _GroupInvitationPreviewFromJson fromJson;
  ...
  set inviterContacts(List<ISunnyContact>? inviterContacts);

  /// Property getter and setter for inviteeContacts:
  List<ISunnyContact>? get inviteeContacts;
  set inviteeContacts(List<ISunnyContact>? inviteeContacts);
...
class GroupInvitationPreviewFields {
  ...
  static const Set<String> values = {groupName, context, inviterContacts, inviteeContacts, matches};
}
...
class GroupInvitationPreviewPaths {
  ...
  static const JsonPath<List<ISunnyContact>> inviterContacts = JsonPath.internal(["inviterContacts"], "/inviterContacts");
  static const JsonPath<List<ISunnyContact>> inviteeContacts = JsonPath.internal(["inviteeContacts"], "/inviteeContacts");
  static const JsonPath<List<dynamic>> matches = JsonPath.internal(["matches"], "/matches");
  static final Set<JsonPath> values = {groupName, context, inviterContacts, inviteeContacts, matches};
}
...
typedef _GroupInvitationPreviewFromJson = IGroupInvitationPreview Function(dynamic any);
