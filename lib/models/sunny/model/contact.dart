...
class ContactFields {
  ...
  static const Set<String> values = {
    dateCreated, dateUpdated, fullName, firstName, lastName, companyName, title, email, timeZone, locale, id, type, userId, deleted, picture, favorite, tags, groups, automations, notes, linkedContacts, identities
  };
}
...
class ContactPaths {
  ...
  static const JsonPath<List<IContact>> linkedContacts = JsonPath.internal(["linkedContacts"], "/linkedContacts");
...
typedef _ContactConstructor = IContact Function({   required DateTime? dateCreated, 
