...
class GroupDataPaths {
  ...
  static const JsonPath<String> identifier =
      JsonPath.internal(["identifier"], "/identifier");
  ...
  static const JsonPath<List<IGroupPermission>> permissions =
      JsonPath.internal(["permissions"], "/permissions");
...
class GroupDataType extends MLiteral<String> {
  ...
  static GroupDataType fromJson(dynamic data) {
    switch (data?.toString()) {
      case "list":
        return GroupDataType.list_;
      case "profile":
        return GroupDataType.profile_;
      default:
...
const GroupDataRef =
    MSchemaRef("mverse", "sunny", "groupData", "0.0.1", "ephemeral");

typedef _GroupDataConstructor = IGroupData Function(
