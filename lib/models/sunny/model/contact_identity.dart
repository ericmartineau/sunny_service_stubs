...
abstract class IContactIdentity
  implements IContactInfo {

  static late _ContactIdentityConstructor of;
  static late _ContactIdentityFromJson fromJson;
  ...
  @override
  IContactIdentity clone();

  @override
  Set<String> get mfields => ContactIdentityFields.values;

}

class ContactIdentityFields {
  ...
  static const Set<String> values = {
    dateCreated, dateUpdated, fullName, firstName, lastName, companyName, title, email, timeZone, locale, phones, emails, addresses, urls, socialProfiles, attachments, dates, interests, id, sourceType, sourceIdentifier
  };
}

class ContactIdentityPaths {
...
const ContactIdentityRef = MSchemaRef("mverse", "sunny", "contactIdentity", "0.0.1", "ephemeral");

typedef _ContactIdentityConstructor = IContactIdentity Function({   required DateTime? dateCreated, 
...
typedef _ContactIdentityFromJson = IContactIdentity Function(dynamic any);