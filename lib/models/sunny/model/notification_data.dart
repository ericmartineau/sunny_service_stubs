...
abstract class INotificationData
  implements MModel {

  static late _NotificationDataConstructor of;
  static late _NotificationDataFromJson fromJson;
  ...
  @override
  INotificationData clone();

  @override
  Set<String> get mfields => NotificationDataFields.values;

}

class NotificationDataFields {
...
const NotificationDataRef = MSchemaRef("mverse", "sunny", "notificationData", "0.0.1", "ephemeral");

typedef _NotificationDataConstructor = INotificationData Function({   String? contactId, 
...
typedef _NotificationDataFromJson = INotificationData Function(dynamic any);