...
abstract class IAuditable
  implements MModel {

  static late _AuditableConstructor of;
  static late _AuditableFromJson fromJson;
...
typedef _AuditableConstructor = IAuditable Function({   required DateTime? dateCreated, 
  required DateTime? dateUpdated
 });
typedef _AuditableFromJson = IAuditable Function(dynamic any);