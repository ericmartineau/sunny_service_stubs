...
abstract class IRelativeDate
  implements MModel {

  static late _RelativeDateConstructor of;
  static late _RelativeDateFromJson fromJson;
...
typedef _RelativeDateConstructor = IRelativeDate Function({   required ISeekDirection? seek, 
  required String? seekUnit, 
  required num? amount, 
  String? timeUnit, 
  String? eventName, 
  IRelativeDate? relativeDate
 });
typedef _RelativeDateFromJson = IRelativeDate Function(dynamic any);